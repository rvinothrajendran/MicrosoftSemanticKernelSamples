...
namespace StreamingDemo
{
    internal class Program
    {
        ...
        {
            Console.WriteLine("Hello, Microsoft Semantic Kernel - 1.0 - Kernel Streaming");
            ...
            //Create SK function from the YAML config
            ...
            await foreach (var result in kernelBuilder.InvokeStreamingAsync(yamlfunction, kernelArguments))
            {
